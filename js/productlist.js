...
fetch(url + "/rest/v1/Svampe?select=name,svampe_img", {
  method: "GET",
  headers: {
    apikey: key,
  },
...
function showProduct(product) {
  ...
  //ændre indhold
  copy.querySelector(".mushroom_img").src = `https://vildmadv2.vps.webdock.io/application/files/7516/2452/5088/Svovlporresvamp_ravarekort_app.png`;
